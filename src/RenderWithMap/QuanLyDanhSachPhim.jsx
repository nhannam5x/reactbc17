...
export default class QuanLyDanhSachPhim extends Component {
  ...
  renderFilms = () =>{
      return this.dataFilm.map((film,index)=>{
          return <div className='col-2' key={film.id}>
              <div className='card'>
                  <img src={film.hinhAnh} alt={film.biDanh} height={300} srcset="" />
                  <div className='card-body'>
                      <p style={{height:35}}>{film.tenPhim}</p>
    ...
    render() {
    return (
      <div style={{ backgroundImage:'url(./img/background/avanger.jpg)', width:'100wh', height:'100vh', backgroundPosition:'center'}}>
          <div className='w-100 h-100' style={{backgroundColor: 'rbga(0,0,0,0.7)'}}>
            <nav className="navbar navbar-expand-sm navbar-dark" style={{backgroundColor:'rbga(200,100,200,.2)'}}>
